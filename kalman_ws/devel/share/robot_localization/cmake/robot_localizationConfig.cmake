...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/edip/kalman_ws/src/robot_localization)
  set(robot_localization_DEVEL_PREFIX /home/edip/kalman_ws/devel)
  ...
  set(robot_localization_INSTALL_PREFIX /home/edip/kalman_ws/install)
...
if(NOT "/home/edip/kalman_ws/devel/include;/home/edip/kalman_ws/src/robot_localization/include;/usr/include/eigen3 " STREQUAL " ")
  set(robot_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/edip/kalman_ws/devel/include;/home/edip/kalman_ws/src/robot_localization/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/edip/kalman_ws/src/robot_localization/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/edip/kalman_ws/devel/lib;/home/edip/kalman_ws/devel/lib;/opt/ros/noetic/lib)
